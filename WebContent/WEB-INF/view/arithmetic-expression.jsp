...
<spring:url value="/resources/js/arithmetic-expression.js"
	var="arithmeticexpressionjs" />
<script type="text/javascript" src="${arithmeticexpressionjs}"></script>
</head>
<body>
	<div class="main-div">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<h2 class="text-center">
						<jspcustomtags:headings>heading1</jspcustomtags:headings>
					</h2>
					<hr>
				</div>
				<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<form:form action="arithmetic-expression-process" method="post" modelAttribute="arithmeticExpressionDetails" id="arithmeticForm">
